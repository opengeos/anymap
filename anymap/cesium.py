...
with open(pathlib.Path(__file__).parent / "static" / "cesium_widget.js", "r", encoding="utf-8") as f:
    _esm_cesium = f.read()

with open(pathlib.Path(__file__).parent / "static" / "cesium_widget.css", "r", encoding="utf-8") as f:
    _css_cesium = f.read()
