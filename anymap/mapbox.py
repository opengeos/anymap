...
with open(pathlib.Path(__file__).parent / "static" / "mapbox_widget.js", "r", encoding="utf-8") as f:
    _esm_mapbox = f.read()

with open(pathlib.Path(__file__).parent / "static" / "mapbox_widget.css", "r", encoding="utf-8") as f:
    _css_mapbox = f.read()
